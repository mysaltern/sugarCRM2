...
class ChartsDashlet extends Dashlet {
    ...
    function setConfigureIcon(){
        ...
        if($this->isConfigurable) 
            $additionalTitle = '<td nowrap width="1%"><div style="width: 100%;text-align:right"><a href="index.php?module=Reports&record=' . $this->report_id . '&action=ReportCriteriaResults&page=report">'
    ...
    function setRefreshIcon(){
        ...
        if($this->isRefreshable)
            $additionalTitle .= '<a href="#" onclick="SUGAR.mySugar.retrieveDashlet(\'' 
                                ...
                                . SugarThemeRegistry::current()->getImageURL('refresh.gif') .'" /></a> ';	
        return $additionalTitle;
    }
