 ...
 * "Powered by SugarCRM".
 ********************************************************************************/
SUGAR.user={fillGmailDefaults:function(){document.getElementById("mail_smtpserver").value='smtp.gmail.com';document.getElementById("mail_smtpport").value='587';document.getElementById("mail_smtpauth_req").checked=true;var ssl=document.getElementById("mail_smtpssl");for(var j=0;j<ssl.options.length;j++)
{if(ssl.options[j].text=='TLS')
{ssl.options[j].selected=true;break;}}
notify_setrequired(document.getElementById("EditView"));},showHideGmailDefaultLink:function(el){var link=document.getElementById("gmailDefaults");if(el.options[el.selectedIndex].value=='SMTP'){link.style.display="inline";}else{link.style.display='none';}}}
