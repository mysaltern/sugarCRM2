...
$xtpl->assign("REPORTS_TO_NAME", get_assigned_user_name($focus->reports_to_id));
...
$selectedEmailLinkType = $focus->getPreference('email_link_type') == null ? "sugar" : $focus->getPreference('email_link_type');
$xtpl->assign('EMAIL_LINK_TYPE',$app_list_strings['dom_email_link_type'][$selectedEmailLinkType]);
...
$xtpl->assign("MAIL_SMTPUSER", $mail_smtpuser);
$xtpl->assign("MAIL_SMTPSERVER", $mail_smtpserver);
