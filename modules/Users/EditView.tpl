	...
	<tr>
		<td>
			<input	id="Save" title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" 
					...
					type="button" name="save" value="  {$APP.LBL_SAVE_BUTTON_LABEL}  " >
		...
		<td>
	        <table width="100%" border="0" cellspacing="0" cellpadding="0">
	        	...
	        	<tr>
					...
					<td width="17%" style='display:{$HIDE_FOR_GROUP_AND_PORTAL}'>
			        	{$MOD.LBL_EMAIL_LINK_TYPE}:&nbsp;{sugar_help text=$MOD.LBL_EMAIL_LINK_TYPE_HELP WIDTH=450}
			        </td>
			        <td width="33%" style='display:{$HIDE_FOR_GROUP_AND_PORTAL}'>
				...
				<tr class="{$HIDE_IF_CAN_USE_DEFAULT_OUTBOUND}" style='display:{$HIDE_FOR_GROUP_AND_PORTAL}'>
					<td width="17%" scope="row"><slot>{$MOD.LBL_MAIL_SMTPSERVER}:&nbsp;{sugar_help text=$MOD.LBL_SMTP_SERVER_HELP WIDTH=450}</slot></td>
					<td width="33%" ><slot><input id='mail_smtpserver' name='mail_smtpserver' type="text" tabindex='5' size='25' maxlength='100' value='{$MAIL_SMTPSERVER}' disabled='disabled'></slot></td>
					<td width="17%" scope="row">&nbsp;</td>
					<td width="33%" >&nbsp;</td>
				</tr>
				<tr class="{$HIDE_IF_CAN_USE_DEFAULT_OUTBOUND}" style='display:{$HIDE_FOR_GROUP_AND_PORTAL}'>
					<td width="17%" scope="row"><slot>{$MOD.LBL_MAIL_SMTPUSER}:</slot></td>
					<td width="33%" ><slot><input id='mail_smtpuser' name='mail_smtpuser' type="text" tabindex='5' size='25' maxlength='100' value='{$MAIL_SMTPUSER}' {$MAIL_USER_PSS_DISABLED}></slot></td>
					<td width="17%" scope="row"><slot>{$MOD.LBL_MAIL_SMTPPASS}:</slot></td>
					<td width="33%" ><slot><input id='mail_smtppass' name='mail_smtppass' type="password" tabindex='6' size='25' maxlength='100' value='{$MAIL_SMTPPASS}' {$MAIL_USER_PSS_DISABLED}></slot></td>
				</tr>
				<tr class="{$HIDE_IF_CAN_USE_DEFAULT_OUTBOUND}" style='display:{$HIDE_FOR_GROUP_AND_PORTAL}'>
