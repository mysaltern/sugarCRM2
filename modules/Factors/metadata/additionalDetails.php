...
function additionalDetailsFactor($fields) {
	...
	return array('fieldToAddTo' => 'NAME', 
				 ...
				 'editLink' => "index.php?action=EditView&module=Factors&return_module=Factors&record={$fields['ID']}", 
				 'viewLink' => "index.php?action=DetailView&module=Factors&return_module=Factors&record={$fields['ID']}");
}
