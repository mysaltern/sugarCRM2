...
$mod_strings = array (
  'LBL_MODULE_NAME' => 'Factors',
  'LBL_MODULE_TITLE' => 'Factors: Home',
...
//END DON'T CONVERT
  'UPDATE' => 'Factor - Currency Update',
  'UPDATE_DOLLARAMOUNTS' => 'Update U.S. Dollar Amounts',
  'UPDATE_VERIFY' => 'Verify Amounts',
  'UPDATE_VERIFY_TXT' => 'Verifies that the amount values in factors are valid decimal numbers with only numeric characters(0-9) and decimals(.)',
  ...
  'UPDATE_DOLLARAMOUNTS_TXT' => 'Update the U.S. Dollar amounts for factors based on the current set currency rates. This value is used to calculate Graphs and List View Currency Amounts.',
