...
<table><tr><td>
<select onchange=" document['{$formName}'].parent_name.value=''; checkParentType(document['{$formName}'].parent_type.value, document['{$formName}'].change_parent); changeQS();" name="parent_type" id="parent_type" tabindex="2">
