...
{html_options name='opportunity_type_basic[]' options=$fields.opportunity_type_basic.options size="6" style="width: 150px" multiple="1" selected=$fields.opportunity_type_basic.value}
   	   	</td>
	</tr>
<tr>
	<td colspan='5'>&nbsp;</td>
