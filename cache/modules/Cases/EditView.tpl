...
<select name="{$fields.priority.name}" id="{$fields.priority.name}" title='' tabindex="101"  >
...
<input type="text" name="{$fields.assigned_user_name.name}" class="sqsEnabled" tabindex="102" id="{$fields.assigned_user_name.name}" size="" value="{$fields.assigned_user_name.value}" title='' autocomplete="off"  >
...
<select name="{$fields.status.name}" id="{$fields.status.name}" title='' tabindex="103"  >
...
<select name="{$fields.type.name}" id="{$fields.type.name}" title='' tabindex="105"  >
...
{/if}  
<input type='text' name='{$fields.name.name}' id='{$fields.name.name}' size='75' maxlength='' value='{$value}' title='' tabindex='106' > 
</tr>
<tr>
...
{/if}  
<textarea id="{$fields.description.name}" name="{$fields.description.name}" rows="8" cols="80" title='' tabindex="107" >{$value}</textarea>
</tr>
<tr>
...
{/if}  
<textarea id="{$fields.resolution.name}" name="{$fields.resolution.name}" rows="5" cols="80" title='' tabindex="108" >{$value}</textarea>
</tr>
</table>
</div>
