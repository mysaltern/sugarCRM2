...
<input type="text" name="{$fields.account_name.name}" class="sqsEnabled" tabindex="103" id="{$fields.account_name.name}" size="11" value="{$fields.account_name.value}" title='' autocomplete="off"  >
