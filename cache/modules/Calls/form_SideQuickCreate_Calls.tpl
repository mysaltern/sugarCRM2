...
<div valign="top">{literal}<input tabindex="100"  type="radio" name="appttype" checked=true onchange="if(this.checked){this.form.module.value='Calls'; this.form.return_module.value='Calls'; this.form.direction.style.display = 'inline';}">{/literal}{sugar_translate label="LBL_CALL"}{literal}<input tabindex="100"  type="radio" name="appttype" onchange="if(this.checked){this.form.module.value='Meetings'; this.form.return_module.value='Meetings'; this.form.direction.style.display='none'}">{/literal}{sugar_translate label="LBL_MEETING"}</div>
</tr>
<tr>
<td valign="top" width='75%' >
...
addToValidate('form_SideQuickCreate_Calls', 'parent_type', 'parent_type', false,'{/literal}{sugar_translate label='LBL_PARENT_TYPE' module='Calls'}{literal}' );
