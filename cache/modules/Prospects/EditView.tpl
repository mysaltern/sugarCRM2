...
{/if}  
<input type='text' name='{$fields.title.name}' id='{$fields.title.name}' size='30' maxlength='' value='{$value}' title='' tabindex='104' > 
...
{/if}  
<input type='text' name='{$fields.department.name}' id='{$fields.department.name}' size='30' maxlength='' value='{$value}' title='' tabindex='106' > 
...
<input autocomplete="off" type="text" name="{$fields.birthdate.name}" id="{$fields.birthdate.name}" value="{$date_value}" title=''  tabindex='108' size="11" maxlength="10">
...
{/if}  
<input type='text' name='{$fields.account_name.name}' id='{$fields.account_name.name}' size='30' maxlength='' value='{$value}' title='' tabindex='110' > 
...
{/if}  
<input type='text' name='{$fields.assistant.name}' id='{$fields.assistant.name}' size='30' maxlength='' value='{$value}' title='' tabindex='111' > 
</tr>
<tr>
...
<input type="checkbox" id="{$fields.do_not_call.name}" name="{$fields.do_not_call.name}" value="1" title='' tabindex="112" {$checked} >
...
{/if}  
<input type='text' name='{$fields.assistant_phone.name}' id='{$fields.assistant_phone.name}' size='30' maxlength='' value='{$value}' title='' tabindex='113' > 
</tr>
<tr>
...
<td width='%'>
<textarea id="primary_address_street" name="primary_address_street" maxlength="150" rows="2" cols="30" tabindex="116">{$fields.primary_address_street.value}</textarea>
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="primary_address_city" id="primary_address_city" size="30" maxlength='150' value='{$fields.primary_address_city.value}' tabindex="116">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="primary_address_state" id="primary_address_state" size="30" maxlength='150' value='{$fields.primary_address_state.value}' tabindex="116">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="primary_address_postalcode" id="primary_address_postalcode" size="30" maxlength='150' value='{$fields.primary_address_postalcode.value}' tabindex="116">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="primary_address_country" id="primary_address_country" size="30" maxlength='150' value='{$fields.primary_address_country.value}' tabindex="116">
</td>
</tr>
<tr>
<td colspan="2">&nbsp;</td>
...
<td width='%'>
<textarea id="alt_address_street" name="alt_address_street" maxlength="150" rows="2" cols="30" tabindex="117">{$fields.alt_address_street.value}</textarea>
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="alt_address_city" id="alt_address_city" size="30" maxlength='150' value='{$fields.alt_address_city.value}' tabindex="117">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="alt_address_state" id="alt_address_state" size="30" maxlength='150' value='{$fields.alt_address_state.value}' tabindex="117">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="alt_address_postalcode" id="alt_address_postalcode" size="30" maxlength='150' value='{$fields.alt_address_postalcode.value}' tabindex="117">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="alt_address_country" id="alt_address_country" size="30" maxlength='150' value='{$fields.alt_address_country.value}' tabindex="117">
</td>
</tr>
<tr>
<td width='%' scope='row' >
...
{/if}  
<textarea id="{$fields.description.name}" name="{$fields.description.name}" rows="6" cols="80" title='' tabindex="118" >{$value}</textarea>
</tr>
<tr>
<td valign="top" id='_label' width='12.5%' scope="row">
</td>
...
addToValidate('EditView', 'full_name', 'fullname', false,'{/literal}{sugar_translate label='LBL_NAME' module='Prospects'}{literal}' );
