...
{html_options name="salutation" options=$fields.salutation.options selected=$fields.salutation.value}&nbsp;<input tabindex="100"  name="first_name" size="25" maxlength="25" type="text" value="{$fields.first_name.value}">
...
{/if}  
<input type='text' name='{$fields.phone_work.name}' id='{$fields.phone_work.name}' size='30' maxlength='' value='{$value}' title='' tabindex='101' > 
</tr>
<tr>
...
{/if}  
<input type='text' name='{$fields.last_name.name}' id='{$fields.last_name.name}' size='30' maxlength='' value='{$value}' title='' tabindex='102' > 
...
{/if}  
<input type='text' name='{$fields.phone_mobile.name}' id='{$fields.phone_mobile.name}' size='30' maxlength='' value='{$value}' title='' tabindex='103' > 
</tr>
<tr>
...
{/if}  
<input type='text' name='{$fields.phone_home.name}' id='{$fields.phone_home.name}' size='30' maxlength='' value='{$value}' title='' tabindex='105' > 
</tr>
<tr>
...
{/if}  
<input type='text' name='{$fields.phone_other.name}' id='{$fields.phone_other.name}' size='30' maxlength='' value='{$value}' title='' tabindex='107' > 
</tr>
<tr>
...
{/if}  
<input type='text' name='{$fields.phone_fax.name}' id='{$fields.phone_fax.name}' size='30' maxlength='' value='{$value}' title='' tabindex='109' > 
</tr>
<tr>
...
{/if}  
<input type='text' name='{$fields.title.name}' id='{$fields.title.name}' size='30' maxlength='' value='{$value}' title='' tabindex='110' > 
<td valign="top" id='birthdate_label' width='12.5%' scope="row">
{capture name="label" assign="label}
...
<input autocomplete="off" type="text" name="{$fields.birthdate.name}" id="{$fields.birthdate.name}" value="{$date_value}" title=''  tabindex='111' size="11" maxlength="10">
<img border="0" src="{sugar_getimagepath file='jscalendar.gif'}" alt="{$APP.LBL_ENTER_DATE}" id="{$fields.birthdate.name}_trigger" align="absmiddle" />
<script type="text/javascript">
...
{/if}  
<input type='text' name='{$fields.department.name}' id='{$fields.department.name}' size='30' maxlength='' value='{$value}' title='' tabindex='112' > 
</tr>
<tr>
...
<input type="text" name="{$fields.report_to_name.name}" class="sqsEnabled" tabindex="113" id="{$fields.report_to_name.name}" size="" value="{$fields.report_to_name.value}" title='' autocomplete="off"  >
<input type="hidden" name="{$fields.report_to_name.id_name}" id="{$fields.report_to_name.id_name}" value="{$fields.reports_to_id.value}">
<input type="button" name="btn_{$fields.report_to_name.name}" id="btn_{$fields.report_to_name.name}" tabindex="113" title="{$APP.LBL_SELECT_BUTTON_TITLE}" accessKey="{$APP.LBL_SELECT_BUTTON_KEY}" class="button" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.report_to_name.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"reports_to_id","last_name":"report_to_name"}}{/literal}, "single", true);' >
<input type="button" name="btn_clr_{$fields.report_to_name.name}" id="btn_clr_{$fields.report_to_name.name}" tabindex="113" title="{$APP.LBL_CLEAR_BUTTON_TITLE}" accessKey="{$APP.LBL_CLEAR_BUTTON_KEY}" class="button" onclick="this.form.{$fields.report_to_name.name}.value = ''; this.form.{$fields.report_to_name.id_name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}" >
<script type="text/javascript">
<!--
enableQS(false);
-->
</script>
<td valign="top" id='assistant_label' width='12.5%' scope="row">
{capture name="label" assign="label}
...
{/if}  
<input type='text' name='{$fields.assistant.name}' id='{$fields.assistant.name}' size='30' maxlength='' value='{$value}' title='' tabindex='114' > 
</tr>
<tr>
...
<input type="checkbox" id="{$fields.sync_contact.name}" name="{$fields.sync_contact.name}" value="1" title='' tabindex="115" {$checked} >
<td valign="top" id='assistant_phone_label' width='12.5%' scope="row">
{capture name="label" assign="label}
...
{/if}  
<input type='text' name='{$fields.assistant_phone.name}' id='{$fields.assistant_phone.name}' size='30' maxlength='' value='{$value}' title='' tabindex='116' > 
</tr>
<tr>
...
<input type="checkbox" id="{$fields.do_not_call.name}" name="{$fields.do_not_call.name}" value="1" title='' tabindex="117" {$checked} >
</tr>
<tr>
...
<tr>
<td valign="top" id="primary_address_street_label" width='%' scope='row' >
{sugar_translate label='LBL_PRIMARY_ADDRESS' module=''}:
</td>
<td width='%'>
<textarea id="primary_address_street" name="primary_address_street" maxlength="150" rows="2" cols="30" tabindex="120">{$fields.primary_address_street.value}</textarea>
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="primary_address_city" id="primary_address_city" size="30" maxlength='150' value='{$fields.primary_address_city.value}' tabindex="120">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="primary_address_state" id="primary_address_state" size="30" maxlength='150' value='{$fields.primary_address_state.value}' tabindex="120">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="primary_address_postalcode" id="primary_address_postalcode" size="30" maxlength='150' value='{$fields.primary_address_postalcode.value}' tabindex="120">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="primary_address_country" id="primary_address_country" size="30" maxlength='150' value='{$fields.primary_address_country.value}' tabindex="120">
</td>
</tr>
<tr>
<td colspan="2">&nbsp;</td>
...
<table border="0" cellspacing="0" cellpadding="0">
<tr>
<td valign="top" id="alt_address_street_label" width='%' scope='row' >
{sugar_translate label='LBL_ALT_ADDRESS' module=''}:
</td>
<td width='%'>
<textarea id="alt_address_street" name="alt_address_street" maxlength="150" rows="2" cols="30" tabindex="121">{$fields.alt_address_street.value}</textarea>
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="alt_address_city" id="alt_address_city" size="30" maxlength='150' value='{$fields.alt_address_city.value}' tabindex="121">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="alt_address_state" id="alt_address_state" size="30" maxlength='150' value='{$fields.alt_address_state.value}' tabindex="121">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="alt_address_postalcode" id="alt_address_postalcode" size="30" maxlength='150' value='{$fields.alt_address_postalcode.value}' tabindex="121">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="alt_address_country" id="alt_address_country" size="30" maxlength='150' value='{$fields.alt_address_country.value}' tabindex="121">
</td>
</tr>
<tr>
<td width='%' scope='row' >
...
{/if}  
<textarea id="{$fields.description.name}" name="{$fields.description.name}" rows="6" cols="80" title='' tabindex="122" >{$value}</textarea>
</tr>
<tr>
<td valign="top" id='_label' width='12.5%' scope="row">
</td>
...
addToValidate('EditView', 'full_name', 'fullname', false,'{/literal}{sugar_translate label='LBL_NAME' module='Contacts'}{literal}' );
