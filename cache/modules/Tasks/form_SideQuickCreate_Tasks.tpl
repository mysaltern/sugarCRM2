...
<input autocomplete="off" type="text" name="{$fields.date_due.name}" id="{$fields.date_due.name}" value="{$date_value}" title=''  tabindex='101' size="11" maxlength="10">
...
<select name="{$fields.priority.name}" id="{$fields.priority.name}" title='' tabindex="102"  >
...
addToValidateDateBefore('form_SideQuickCreate_Tasks', 'date_start', 'datetime', false,'{/literal}{sugar_translate label='LBL_START_DATE' module='Tasks'}{literal}', 'date_due' );
addToValidate('form_SideQuickCreate_Tasks', 'date_start_field_date', 'date', false,'Due Date & Time' );
addToValidate('form_SideQuickCreate_Tasks', 'parent_type', 'parent_type', false,'{/literal}{sugar_translate label='LBL_PARENT_NAME' module='Tasks'}{literal}' );
...
</script><script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['form_SideQuickCreate_Tasks_assigned_user_name']={"form":"form_SideQuickCreate_Tasks","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};</script>{/literal}
