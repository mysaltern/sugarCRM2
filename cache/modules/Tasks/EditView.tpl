...
<script type="text/javascript">
var combo_{$fields.date_due.name} = new Datetimecombo("{$fields[$fields.date_due.name].value}", "{$fields.date_due.name}", "{$TIME_FORMAT}", 102, '1', '{$fields[$fields.date_due.name_flag].value}'); 
...
{/if}
<input type="text" name="{$fields.parent_name.name}" id="{$fields.parent_name.name}" class="sqsEnabled" tabindex="103" size="" {if $keepParent}value="{$fields.parent_name.value}"{/if} autocomplete="off">
...
<script type="text/javascript" src="include/SugarFields/Fields/Datetimecombo/Datetimecombo.js"></script>
<script type="text/javascript">
var combo_{$fields.date_start.name} = new Datetimecombo("{$fields[$fields.date_start.name].value}", "{$fields.date_start.name}", "{$TIME_FORMAT}", 104, '1', '{$fields[$fields.date_start.name_flag].value}'); 
//Render the remaining widget fields
...
<select name="{$fields.priority.name}" id="{$fields.priority.name}" title='' tabindex="106"  >
...
{/if}  
<textarea id="{$fields.description.name}" name="{$fields.description.name}" rows="8" cols="60" title='' tabindex="108" >{$value}</textarea>
</tr>
</table>
</div>
...
addToValidateDateBefore('EditView', 'date_start', 'datetime', false,'{/literal}{sugar_translate label='LBL_START_DATE' module='Tasks'}{literal}', 'date_due' );
