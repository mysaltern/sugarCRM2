...
<select name="{$fields.lead_source.name}" id="{$fields.lead_source.name}" title='' tabindex="100"  >
...
{/if}  
<textarea id="{$fields.lead_source_description.name}" name="{$fields.lead_source_description.name}" rows="4" cols="40" title='' tabindex="102" >{$value}</textarea>
...
{/if}  
<textarea id="{$fields.status_description.name}" name="{$fields.status_description.name}" rows="4" cols="40" title='' tabindex="103" >{$value}</textarea>
</tr>
<tr>
...
{/if}  
<input type='text' name='{$fields.opportunity_amount.name}' id='{$fields.opportunity_amount.name}' size='30' maxlength='' value='{$value}' title='' tabindex='105' > 
</tr>
<tr>
...
{/if}  
<input type='text' name='{$fields.refered_by.name}' id='{$fields.refered_by.name}' size='30' maxlength='' value='{$value}' title='' tabindex='106' > 
</tr>
<tr>
...
<td valign="top" width='37.5%' >
{counter name="panelFieldCount"}
{html_options id="salutation" name="salutation" options=$fields.salutation.options selected=$fields.salutation.value}&nbsp;<input tabindex="107"  id="first_name" name="first_name" size="25" maxlength="25" type="text" value="{$fields.first_name.value}">
...
{/if}  
<input type='text' name='{$fields.phone_work.name}' id='{$fields.phone_work.name}' size='30' maxlength='' value='{$value}' title='' tabindex='108' > 
</tr>
<tr>
...
{/if}  
<input type='text' name='{$fields.last_name.name}' id='{$fields.last_name.name}' size='30' maxlength='' value='{$value}' title='' tabindex='109' > 
...
{/if}  
<input type='text' name='{$fields.phone_mobile.name}' id='{$fields.phone_mobile.name}' size='30' maxlength='' value='{$value}' title='' tabindex='110' > 
</tr>
<tr>
...
{/if}  
<input type='text' name='{$fields.phone_home.name}' id='{$fields.phone_home.name}' size='30' maxlength='' value='{$value}' title='' tabindex='112' > 
</tr>
<tr>
...
<td valign="top" width='37.5%' >
{counter name="panelFieldCount"}
<input tabindex="113"  name="account_name" {if ($fields.converted.value == 1)}disabled="true"{/if} size="30" maxlength="255" type="text" value="{$fields.account_name.value}">
...
{/if}  
<input type='text' name='{$fields.phone_other.name}' id='{$fields.phone_other.name}' size='30' maxlength='' value='{$value}' title='' tabindex='114' > 
</tr>
<tr>
...
{/if}  
<input type='text' name='{$fields.phone_fax.name}' id='{$fields.phone_fax.name}' size='30' maxlength='' value='{$value}' title='' tabindex='116' > 
</tr>
<tr>
...
{/if}  
<input type='text' name='{$fields.title.name}' id='{$fields.title.name}' size='30' maxlength='' value='{$value}' title='' tabindex='117' > 
...
<input type="checkbox" id="{$fields.do_not_call.name}" name="{$fields.do_not_call.name}" value="1" title='' tabindex="118" {$checked} >
</tr>
<tr>
...
{/if}  
<input type='text' name='{$fields.department.name}' id='{$fields.department.name}' size='30' maxlength='' value='{$value}' title='' tabindex='119' > 
</tr>
<tr>
...
<td width='%'>
<textarea id="primary_address_street" name="primary_address_street" maxlength="150" rows="2" cols="30" tabindex="123">{$fields.primary_address_street.value}</textarea>
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="primary_address_city" id="primary_address_city" size="30" maxlength='150' value='{$fields.primary_address_city.value}' tabindex="123">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="primary_address_state" id="primary_address_state" size="30" maxlength='150' value='{$fields.primary_address_state.value}' tabindex="123">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="primary_address_postalcode" id="primary_address_postalcode" size="30" maxlength='150' value='{$fields.primary_address_postalcode.value}' tabindex="123">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="primary_address_country" id="primary_address_country" size="30" maxlength='150' value='{$fields.primary_address_country.value}' tabindex="123">
</td>
</tr>
<tr>
<td colspan="2">&nbsp;</td>
...
<td width='%'>
<textarea id="alt_address_street" name="alt_address_street" maxlength="150" rows="2" cols="30" tabindex="124">{$fields.alt_address_street.value}</textarea>
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="alt_address_city" id="alt_address_city" size="30" maxlength='150' value='{$fields.alt_address_city.value}' tabindex="124">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="alt_address_state" id="alt_address_state" size="30" maxlength='150' value='{$fields.alt_address_state.value}' tabindex="124">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="alt_address_postalcode" id="alt_address_postalcode" size="30" maxlength='150' value='{$fields.alt_address_postalcode.value}' tabindex="124">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="alt_address_country" id="alt_address_country" size="30" maxlength='150' value='{$fields.alt_address_country.value}' tabindex="124">
</td>
</tr>
<tr>
<td width='%' scope='row' >
...
{/if}  
<textarea id="{$fields.description.name}" name="{$fields.description.name}" rows="4" cols="60" title='' tabindex="125" >{$value}</textarea>
</tr>
<tr>
<td valign="top" id='_label' width='12.5%' scope="row">
</td>
