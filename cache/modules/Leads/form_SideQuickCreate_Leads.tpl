...
{/if}  
<input type='text' name='{$fields.first_name.name}' id='{$fields.first_name.name}' size='20' maxlength='' value='{$value}' title='' tabindex='100' > 
</tr>
<tr>
<td valign="top" width='75%' >
...
{/if}  
<input type='text' name='{$fields.last_name.name}' id='{$fields.last_name.name}' size='20' maxlength='' value='{$value}' title='' tabindex='101' > 
</tr>
<tr>
<td valign="top" width='75%' >
...
{/if}  
<input type='text' name='{$fields.phone_work.name}' id='{$fields.phone_work.name}' size='20' maxlength='' value='{$value}' title='' tabindex='102' > 
</tr>
<tr>
<td valign="top" width='75%' >
...
addToValidate('form_SideQuickCreate_Leads', 'full_name', 'fullname', false,'{/literal}{sugar_translate label='LBL_NAME' module='Leads'}{literal}' );
...
addToValidate('form_SideQuickCreate_Leads', 'birthdate', 'date', false,'{/literal}{sugar_translate label='LBL_BIRTHDATE' module='Leads'}{literal}' );
