...
{/if}  
<input type='text' name='{$fields.first_name_basic.name}' id='{$fields.first_name_basic.name}' size='30' maxlength='' value='{$value}' title='' tabindex='' > 
   	   	</td>
	{counter assign=index}
	{math equation="left % right"
   		  left=$index
...
{/if}  
<input type='text' name='{$fields.last_name_basic.name}' id='{$fields.last_name_basic.name}' size='30' maxlength='' value='{$value}' title='' tabindex='' > 
   	   	</td>
	{counter assign=index}
	{math equation="left % right"
   		  left=$index
...
{html_options name='lead_source_basic[]' options=$fields.lead_source_basic.options size="6" style="width: 150px" multiple="1" selected=$fields.lead_source_basic.value}
   	   	</td>
	</tr>
<tr>
	<td colspan='5'>&nbsp;</td>
