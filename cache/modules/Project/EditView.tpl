...
<select name="{$fields.priority.name}" id="{$fields.priority.name}" title='' tabindex="105"  >
...
{/if}  
<textarea id="{$fields.description.name}" name="{$fields.description.name}" rows="8" cols="60" title='' tabindex="106" >{$value}</textarea>
</tr>
</table>
</div>
