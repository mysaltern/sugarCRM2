...
<tr>
<td valign="top" id='start_date_label' width='12.5%' scope="row">
{capture name="label" assign="label}
...
<input autocomplete="off" type="text" name="{$fields.start_date.name}" id="{$fields.start_date.name}" value="{$date_value}" title=''  tabindex='103' size="11" maxlength="10">
<img border="0" src="{sugar_getimagepath file='jscalendar.gif'}" alt="{$APP.LBL_ENTER_DATE}" id="{$fields.start_date.name}_trigger" align="absmiddle" />
...
<tr>
<td valign="top" id='end_date_label' width='12.5%' scope="row">
{capture name="label" assign="label}
...
<input autocomplete="off" type="text" name="{$fields.end_date.name}" id="{$fields.end_date.name}" value="{$date_value}" title=''  tabindex='105' size="11" maxlength="10">
<img border="0" src="{sugar_getimagepath file='jscalendar.gif'}" alt="{$APP.LBL_ENTER_DATE}" id="{$fields.end_date.name}_trigger" align="absmiddle" />
&nbsp;(<span class="dateFormat">{$USER_DATEFORMAT}</span>)
<script type="text/javascript">
Calendar.setup ({ldelim}
...
<tr>
<td valign="top" id='campaign_type_label' width='12.5%' scope="row">
{capture name="label" assign="label}
...
<select name="{$fields.campaign_type.name}" id="{$fields.campaign_type.name}" title='' tabindex="106"  onchange="type_change();">
...
<td valign="top" id='frequency_label' width='12.5%' scope="row">
...
<td valign="top" id='impressions_label' width='12.5%' scope="row">
{capture name="label" assign="label}
...
{/if}  
<input type='text' name='{$fields.impressions.name}' id='{$fields.impressions.name}' size='30'  value='{$value}' title='' tabindex='109' > 
</tr>
<tr>
<td valign="top" id='budget_label' width='12.5%' scope="row">
{capture name="label" assign="label}
...
{/if}  
<input type='text' name='{$fields.budget.name}' id='{$fields.budget.name}' size='30'  value='{$value}' title='' tabindex='110' > 
<td valign="top" id='actual_cost_label' width='12.5%' scope="row">
{capture name="label" assign="label}
...
{/if}  
<input type='text' name='{$fields.actual_cost.name}' id='{$fields.actual_cost.name}' size='30'  value='{$value}' title='' tabindex='111' > 
</tr>
<tr>
<td valign="top" id='expected_revenue_label' width='12.5%' scope="row">
{capture name="label" assign="label}
...
{/if}  
<input type='text' name='{$fields.expected_revenue.name}' id='{$fields.expected_revenue.name}' size='30'  value='{$value}' title='' tabindex='112' > 
<td valign="top" id='expected_cost_label' width='12.5%' scope="row">
{capture name="label" assign="label}
...
{/if}  
<input type='text' name='{$fields.expected_cost.name}' id='{$fields.expected_cost.name}' size='30'  value='{$value}' title='' tabindex='113' > 
</tr>
<tr>
<td valign="top" id='objective_label' width='12.5%' scope="row">
{capture name="label" assign="label}
...
{/if}  
<textarea id="{$fields.objective.name}" name="{$fields.objective.name}" rows="8" cols="80" title='' tabindex="114" >{$value}</textarea>
</tr>
<tr>
<td valign="top" id='content_label' width='12.5%' scope="row">
{capture name="label" assign="label}
...
{/if}  
<textarea id="{$fields.content.name}" name="{$fields.content.name}" rows="8" cols="80" title='' tabindex="115" >{$value}</textarea>
</tr>
</table>
</div>
...
<script type="text/javascript" src="include/javascript/popup_parent_helper.js?s=f91b80931d036564d1ee2347da73dad0&c=1"></script>
<script type="text/javascript">
