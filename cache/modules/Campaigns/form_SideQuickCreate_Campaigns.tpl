...
<input autocomplete="off" type="text" name="{$fields.end_date.name}" id="{$fields.end_date.name}" value="{$date_value}" title=''  tabindex='102' size="11" maxlength="10">
...
<select name="{$fields.campaign_type.name}" id="{$fields.campaign_type.name}" title='' tabindex="103"  >
...
addToValidate('form_SideQuickCreate_Campaigns', 'date_entered_date', 'date', false,'Date Entered' );
addToValidate('form_SideQuickCreate_Campaigns', 'date_modified_date', 'date', false,'Date Modified' );
...
</script><script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['form_SideQuickCreate_Campaigns_assigned_user_name']={"form":"form_SideQuickCreate_Campaigns","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};</script>{/literal}
