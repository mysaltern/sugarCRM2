...
{sugar_translate label='Account Name' module='Accounts'}:
...
{/if}  
<input type='text' name='{$fields.phone_office.name}' id='{$fields.phone_office.name}' size='20' maxlength='' value='{$value}' title='' tabindex='101' > 
</tr>
<tr>
<td valign="top" width='75%' >
...
<input type='text' name='{$fields.website.name}' id='{$fields.website.name}' size='20' 
...
<input type="text" name="{$fields.assigned_user_name.name}" class="sqsEnabled" tabindex="103" id="{$fields.assigned_user_name.name}" size="11" value="{$fields.assigned_user_name.value}" title='' autocomplete="off"  >
...
addToValidate('form_SideQuickCreate_Accounts', 'campaign_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CAMPAIGN' module='Accounts'}{literal}' );
