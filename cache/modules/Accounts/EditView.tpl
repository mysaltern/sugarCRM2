...
{/if}  
<input type='text' name='{$fields.phone_office.name}' id='{$fields.phone_office.name}' size='30' maxlength='' value='{$value}' title='' tabindex='101' > 
</tr>
<tr>
...
{/if}  
<input type='text' name='{$fields.phone_fax.name}' id='{$fields.phone_fax.name}' size='30' maxlength='' value='{$value}' title='' tabindex='103' > 
</tr>
<tr>
...
{/if}  
<input type='text' name='{$fields.ticker_symbol.name}' id='{$fields.ticker_symbol.name}' size='30' maxlength='' value='{$value}' title='' tabindex='104' > 
...
{/if}  
<input type='text' name='{$fields.phone_alternate.name}' id='{$fields.phone_alternate.name}' size='30' maxlength='' value='{$value}' title='' tabindex='105' > 
</tr>
<tr>
...
<input type="text" name="{$fields.parent_name.name}" class="sqsEnabled" tabindex="106" id="{$fields.parent_name.name}" size="" value="{$fields.parent_name.value}" title='' autocomplete="off"  >
...
{/if}  
<input type='text' name='{$fields.employees.name}' id='{$fields.employees.name}' size='30' maxlength='' value='{$value}' title='' tabindex='107' > 
</tr>
<tr>
...
{/if}  
<input type='text' name='{$fields.ownership.name}' id='{$fields.ownership.name}' size='30' maxlength='' value='{$value}' title='' tabindex='108' > 
...
{/if}  
<input type='text' name='{$fields.rating.name}' id='{$fields.rating.name}' size='30' maxlength='' value='{$value}' title='' tabindex='109' > 
</tr>
<tr>
...
<select name="{$fields.industry.name}" id="{$fields.industry.name}" title='' tabindex="110"  >
...
{/if}  
<input type='text' name='{$fields.sic_code.name}' id='{$fields.sic_code.name}' size='30' maxlength='' value='{$value}' title='' tabindex='111' > 
</tr>
<tr>
...
{/if}  
<input type='text' name='{$fields.annual_revenue.name}' id='{$fields.annual_revenue.name}' size='30' maxlength='' value='{$value}' title='' tabindex='113' > 
</tr>
<tr>
...
<input type="text" name="{$fields.campaign_name.name}" class="sqsEnabled" tabindex="114" id="{$fields.campaign_name.name}" size="" value="{$fields.campaign_name.value}" title='' autocomplete="off"  >
<input type="hidden" name="{$fields.campaign_name.id_name}" id="{$fields.campaign_name.id_name}" value="{$fields.campaign_id.value}">
<input type="button" name="btn_{$fields.campaign_name.name}" id="btn_{$fields.campaign_name.name}" tabindex="114" title="{$APP.LBL_SELECT_BUTTON_TITLE}" accessKey="{$APP.LBL_SELECT_BUTTON_KEY}" class="button" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.campaign_name.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"campaign_id","name":"campaign_name"}}{/literal}, "single", true);' >
<input type="button" name="btn_clr_{$fields.campaign_name.name}" id="btn_clr_{$fields.campaign_name.name}" tabindex="114" title="{$APP.LBL_CLEAR_BUTTON_TITLE}" accessKey="{$APP.LBL_CLEAR_BUTTON_KEY}" class="button" onclick="this.form.{$fields.campaign_name.name}.value = ''; this.form.{$fields.campaign_name.id_name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}" >
<script type="text/javascript">
<!--
enableQS(false);
-->
...
<input type="text" name="{$fields.assigned_user_name.name}" class="sqsEnabled" tabindex="115" id="{$fields.assigned_user_name.name}" size="" value="{$fields.assigned_user_name.value}" title='' autocomplete="off"  >
...
<tr>
<td valign="top" id="billing_address_street_label" width='%' scope='row' >
{sugar_translate label='LBL_BILLING_ADDRESS' module=''}:
</td>
<td width='%'>
<textarea id="billing_address_street" name="billing_address_street" maxlength="150" rows="2" cols="30" tabindex="116">{$fields.billing_address_street.value}</textarea>
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="billing_address_city" id="billing_address_city" size="30" maxlength='150' value='{$fields.billing_address_city.value}' tabindex="116">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="billing_address_state" id="billing_address_state" size="30" maxlength='150' value='{$fields.billing_address_state.value}' tabindex="116">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="billing_address_postalcode" id="billing_address_postalcode" size="30" maxlength='150' value='{$fields.billing_address_postalcode.value}' tabindex="116">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="billing_address_country" id="billing_address_country" size="30" maxlength='150' value='{$fields.billing_address_country.value}' tabindex="116">
</td>
</tr>
<tr>
<td colspan="2">&nbsp;</td>
...
<table border="0" cellspacing="0" cellpadding="0">
<tr>
<td valign="top" id="shipping_address_street_label" width='%' scope='row' >
{sugar_translate label='LBL_SHIPPING_ADDRESS' module=''}:
</td>
<td width='%'>
<textarea id="shipping_address_street" name="shipping_address_street" maxlength="150" rows="2" cols="30" tabindex="117">{$fields.shipping_address_street.value}</textarea>
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="shipping_address_city" id="shipping_address_city" size="30" maxlength='150' value='{$fields.shipping_address_city.value}' tabindex="117">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="shipping_address_state" id="shipping_address_state" size="30" maxlength='150' value='{$fields.shipping_address_state.value}' tabindex="117">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="shipping_address_postalcode" id="shipping_address_postalcode" size="30" maxlength='150' value='{$fields.shipping_address_postalcode.value}' tabindex="117">
</td>
</tr>
<tr>
...
<td width='%'>
<input type="text" name="shipping_address_country" id="shipping_address_country" size="30" maxlength='150' value='{$fields.shipping_address_country.value}' tabindex="117">
</td>
</tr>
<tr>
<td width='%' scope='row' >
...
{/if}  
<textarea id="{$fields.description.name}" name="{$fields.description.name}" rows="6" cols="80" title='' tabindex="119" >{$value}</textarea>
</tr>
<tr>
<td valign="top" id='_label' width='12.5%' scope="row">
</td>
