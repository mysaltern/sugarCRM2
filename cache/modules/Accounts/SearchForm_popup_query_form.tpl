...
{/if}  
<input type='text' name='{$fields.billing_address_city_advanced.name}' id='{$fields.billing_address_city_advanced.name}' size='30' maxlength='' value='{$value}' title='' tabindex='' > 
   	   	</td>
...
{/if}  
<input type='text' name='{$fields.billing_address_state_advanced.name}' id='{$fields.billing_address_state_advanced.name}' size='30' maxlength='' value='{$value}' title='' tabindex='' > 
   	   	</td>
