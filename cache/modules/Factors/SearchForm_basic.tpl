...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
			{sugar_translate label='LBL_OPPORTUNITY_NAME' module='Factors'}
		</td>
...
<input type="button" name="btn_clr_{$fields.account_name_basic.name}" tabindex="" title="{$APP.LBL_CLEAR_BUTTON_TITLE}" accessKey="{$APP.LBL_CLEAR_BUTTON_KEY}" class="button" onclick="this.form.{$fields.account_name_basic.name}.value = ''; this.form.{$fields.account_id_basic.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		{sugar_translate label='LBL_CURRENT_USER_FILTER' module='Factors'}
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{html_options name='factor_type_basic[]' options=$fields.factor_type_basic.options size="6" style="width: 150px" multiple="1" selected=$fields.factor_type_basic.value}
   	   	</td>
	</tr>
<tr>
	<td colspan='5'>&nbsp;</td>
