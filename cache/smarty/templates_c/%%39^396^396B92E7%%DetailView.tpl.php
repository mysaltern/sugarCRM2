<?php /* Smarty version 2.6.11, created on 2021-02-02 11:51:05
         compiled from cache/modules/Meetings/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Meetings/DetailView.tpl', 32, false),array('function', 'counter', 'cache/modules/Meetings/DetailView.tpl', 34, false),array('function', 'sugar_translate', 'cache/modules/Meetings/DetailView.tpl', 40, false),array('modifier', 'strip_semicolon', 'cache/modules/Meetings/DetailView.tpl', 42, false),array('modifier', 'url2html', 'cache/modules/Meetings/DetailView.tpl', 171, false),array('modifier', 'nl2br', 'cache/modules/Meetings/DetailView.tpl', 171, false),)), $this); ?>
...
" class="button" onclick="this.form.return_module.value='Meetings'; this.form.return_action.value='DetailView'; this.form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="this.form.return_module.value='Meetings'; this.form.return_action.value='DetailView'; this.form.isDuplicate.value=true; this.form.action.value='EditView'; this.form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="this.form.return_module.value='Meetings'; this.form.return_action.value='ListView'; this.form.action.value='Delete'; return confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
"  class="button"  onclick="this.form.status.value='Held'; this.form.action.value='Save';this.form.return_module.value='Meetings';this.form.isDuplicate.value=true;this.form.isSaveAndNew.value=true;this.form.return_action.value='EditView'; this.form.isDuplicate.value=true;this.form.return_id.value='<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
...
"  class="button"  onclick="this.form.status.value='Held'; this.form.action.value='Save';this.form.return_module.value='Meetings';this.form.isSave.value=true;this.form.return_action.value='DetailView'; this.form.return_id.value='<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
...
<span id='<?php echo $this->_tpl_vars['fields']['location']['name']; ?>
...
<tr>
<td width='12.5%' scope="row">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_TIME','module' => 'Meetings'), $this);?>
...
<tr>
<td width='12.5%' scope="row">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_MODIFIED','module' => 'Meetings'), $this);?>
...
<tr>
<td width='12.5%' scope="row">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'Meetings'), $this);?>
...
<td width='12.5%' scope="row">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'Meetings'), $this);?>
