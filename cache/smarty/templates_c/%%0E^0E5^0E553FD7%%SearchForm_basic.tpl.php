...
' title='' tabindex='' > 
		...
		<td  nowrap="nowrap" width='25%'>
			...
			<?php if (strlen ( $this->_tpl_vars['fields']['billing_address_city_basic']['value'] ) <= 0): ?>
				<?php $this->assign('value', $this->_tpl_vars['fields']['billing_address_city_basic']['default_value']); ?>
			<?php else: ?>
				<?php $this->assign('value', $this->_tpl_vars['fields']['billing_address_city_basic']['value']); ?>
			<?php endif; ?>  
...
' title='' tabindex='' > 
		...
		<td  nowrap="nowrap" width='25%'>
			...
			<?php if (strlen ( $this->_tpl_vars['fields']['phone_office_basic']['value'] ) <= 0): ?>
				<?php $this->assign('value', $this->_tpl_vars['fields']['phone_office_basic']['default_value']); ?>
			<?php else: ?>
				<?php $this->assign('value', $this->_tpl_vars['fields']['phone_office_basic']['value']); ?>
			<?php endif; ?>  
...
' title='' tabindex='' > 
		...
		<td  nowrap="nowrap" width='25%'>
			...
			<?php if (strlen ( $this->_tpl_vars['fields']['address_street_basic']['value'] ) <= 0): ?>
				<?php $this->assign('value', $this->_tpl_vars['fields']['address_street_basic']['default_value']); ?>
			<?php else: ?>
				<?php $this->assign('value', $this->_tpl_vars['fields']['address_street_basic']['value']); ?>
			<?php endif; ?>  
