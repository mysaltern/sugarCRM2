<?php /* Smarty version 2.6.11, created on 2021-01-18 09:09:02
         compiled from cache/modules/Accounts/form_SideQuickCreate_Accounts.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Accounts/form_SideQuickCreate_Accounts.tpl', 30, false),array('function', 'counter', 'cache/modules/Accounts/form_SideQuickCreate_Accounts.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/Accounts/form_SideQuickCreate_Accounts.tpl', 39, false),array('modifier', 'default', 'cache/modules/Accounts/form_SideQuickCreate_Accounts.tpl', 36, false),)), $this); ?>
...
<?php echo smarty_function_sugar_translate(array('label' => 'Account Name','module' => 'Accounts'), $this);?>
:
...
addToValidate(\'form_SideQuickCreate_Accounts\', \'date_entered_date\', \'date\', false,\'Date Entered\' );
addToValidate(\'form_SideQuickCreate_Accounts\', \'date_modified_date\', \'date\', false,\'Date Modified\' );
...
addToValidate(\'form_SideQuickCreate_Accounts\', \'campaign_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CAMPAIGN','module' => 'Accounts'), $this); echo '\' );
...
</script><script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'form_SideQuickCreate_Accounts_assigned_user_name\']={"form":"form_SideQuickCreate_Accounts","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};</script>'; ?>
