...
" class="sqsEnabled" tabindex="102" id="<?php echo $this->_tpl_vars['fields']['assigned_user_name']['name']; ?>
...
' size='75' maxlength='' value='<?php echo $this->_tpl_vars['value']; ?>
' title='' tabindex='106' > 
</tr>
<tr>
...
" rows="5" cols="80" title='' tabindex="108" ><?php echo $this->_tpl_vars['value']; ?>
</textarea>
</tr>
</table>
</div>
...
addToValidate(\'EditView\', \'parent_name\', \'parent\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LIST_RELATED_TO','module' => 'Cases'), $this); echo '\' );
addToValidate(\'EditView\', \'parent_id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LIST_RELATED_TO_ID','module' => 'Cases'), $this); echo '\' );
