<?php /* Smarty version 2.6.11, created on 2021-02-08 09:46:35
         compiled from cache/modules/Leads/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'cache/modules/Leads/DetailView.tpl', 7, false),array('modifier', 'strip_semicolon', 'cache/modules/Leads/DetailView.tpl', 82, false),array('modifier', 'url2html', 'cache/modules/Leads/DetailView.tpl', 111, false),array('modifier', 'nl2br', 'cache/modules/Leads/DetailView.tpl', 111, false),array('function', 'sugar_include', 'cache/modules/Leads/DetailView.tpl', 72, false),array('function', 'counter', 'cache/modules/Leads/DetailView.tpl', 74, false),array('function', 'sugar_translate', 'cache/modules/Leads/DetailView.tpl', 80, false),array('function', 'sugar_phone', 'cache/modules/Leads/DetailView.tpl', 174, false),)), $this); ?>
...
" class="button" onclick="this.form.return_module.value='Leads'; this.form.return_action.value='DetailView'; this.form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
"><?php endif; ?> 
<td class="buttons" align="left" NOWRAP>
<input title="<?php echo $this->_tpl_vars['MOD']['LBL_CONVERTLEAD_TITLE']; ?>
...
" accessKey="M" class="button" onclick="this.form.return_module.value='Leads'; this.form.return_action.value='DetailView';this.form.return_id.value='<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
...
<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['fields']['lead_source_description']['value'])) ? $this->_run_mod_handler('url2html', true, $_tmp) : url2html($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
...
<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['fields']['status_description']['value'])) ? $this->_run_mod_handler('url2html', true, $_tmp) : url2html($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
...
<span id='<?php echo $this->_tpl_vars['fields']['opportunity_amount']['name']; ?>
...
<span id='<?php echo $this->_tpl_vars['fields']['refered_by']['name']; ?>
...
<tr>
<td width='12.5%' scope="row">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'Leads'), $this);?>
...
<input type="submit" name="vCardButton" value="<?php echo $this->_tpl_vars['APP']['LBL_VCARD']; ?>
">
</form>
</td>
<td width='12.5%' scope="row">
...
<tr>
<td width='12.5%' scope="row">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_BIRTHDATE','module' => 'Leads'), $this);?>
...
<span id='<?php echo $this->_tpl_vars['fields']['birthdate']['name']; ?>
...
<span id='<?php echo $this->_tpl_vars['fields']['account_name']['name']; ?>
...
<tr>
<td width='12.5%' scope="row">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_MODIFIED','module' => 'Leads'), $this);?>
...
<td width='12.5%' scope="row">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'Leads'), $this);?>
...
<tr>
<td width='12.5%' scope="row">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS','module' => 'Leads'), $this);?>
...
<td width='12.5%' scope="row">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ALTERNATE_ADDRESS','module' => 'Leads'), $this);?>
