<?php /* Smarty version 2.6.11, created on 2021-02-05 21:36:37
...
" class="button" onclick="this.form.return_module.value='Factors'; this.form.return_action.value='DetailView'; this.form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="this.form.return_module.value='Factors'; this.form.return_action.value='DetailView'; this.form.isDuplicate.value=true; this.form.action.value='EditView'; this.form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="this.form.return_module.value='Factors'; this.form.return_action.value='ListView'; this.form.action.value='Delete'; return confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" accesskey="M" class="button" onclick="this.form.return_module.value='Factors';this.form.return_action.value='DetailView';this.form.return_id.value='<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
