<?php /* Smarty version 2.6.11, created on 2021-01-31 09:14:14
         compiled from cache/modules/Calls/form_SideQuickCreate_Calls.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Calls/form_SideQuickCreate_Calls.tpl', 37, false),array('function', 'counter', 'cache/modules/Calls/form_SideQuickCreate_Calls.tpl', 42, false),array('function', 'sugar_translate', 'cache/modules/Calls/form_SideQuickCreate_Calls.tpl', 47, false),array('function', 'sugar_getimagepath', 'cache/modules/Calls/form_SideQuickCreate_Calls.tpl', 74, false),array('function', 'html_options', 'cache/modules/Calls/form_SideQuickCreate_Calls.tpl', 122, false),array('modifier', 'default', 'cache/modules/Calls/form_SideQuickCreate_Calls.tpl', 43, false),)), $this); ?>
...
<div valign="top"><?php echo '<input tabindex="100"  type="radio" name="appttype" checked=true onchange="if(this.checked){this.form.module.value=\'Calls\'; this.form.return_module.value=\'Calls\'; this.form.direction.style.display = \'inline\';}">';  echo smarty_function_sugar_translate(array('label' => 'LBL_CALL'), $this); echo '<input tabindex="100"  type="radio" name="appttype" onchange="if(this.checked){this.form.module.value=\'Meetings\'; this.form.return_module.value=\'Meetings\'; this.form.direction.style.display=\'none\'}">';  echo smarty_function_sugar_translate(array('label' => 'LBL_MEETING'), $this);?>
</div>
</tr>
<tr>
<td valign="top" width='75%' >
...
addToValidate(\'form_SideQuickCreate_Calls\', \'parent_type\', \'parent_type\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PARENT_TYPE','module' => 'Calls'), $this); echo '\' );
...
</script><script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'form_SideQuickCreate_Calls_parent_name\']={"form":"form_SideQuickCreate_Calls","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["parent_name","parent_id"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'form_SideQuickCreate_Calls_assigned_user_name\']={"form":"form_SideQuickCreate_Calls","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};</script>'; ?>
