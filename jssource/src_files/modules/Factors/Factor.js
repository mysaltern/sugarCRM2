...
function set_factorlog_and_save_background(popup_reply_data)
{
    ...
    query_array.push('return_type=addfactorlog');
...
function validatePortalName(e) {
    ...
    if(portalName.value != '' && !verifyingPortalName) {    
	   ...
	   var cObj = YAHOO.util.Connect.asyncRequest('POST', 'index.php?module=Cases&action=ValidPortalUsername&portal_name=' + portalName.value, {success: callbackFunction, failure: callbackFunction});
    }
}
