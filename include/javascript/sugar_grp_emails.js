...
SE.listView = {
     ...
     */
     ...
     refreshGrid : function() {
         SUGAR.email2.grid.getDataSource().sendRequest(
     	    SUGAR.util.paramsToUrl(SUGAR.email2.grid.params), 
     		SUGAR.email2.grid.onDataReturnInitializeTable,
     		SUGAR.email2.grid
     	);
     }
};
