...
<select name="{{sugarvar key='name'}}" id="{{sugarvar key='name'}}" title='{{$vardef.help}}' tabindex="{{$tabindex}}" {{$displayParams.field}} {{if isset($displayParams.javascript)}}{{$displayParams.javascript}}{{/if}}>
