...
class SugarView
{
    ...
    function displayHeader()
    {
        ...
        if (isset($_SESSION["authenticated_user_id"])) {
            ...
            // new record
            if(file_exists("custom/modules/".$this->module."/Forms.php")){
            	require_once("custom/modules/".$this->module."/Forms.php");
            }else if(file_exists("modules/".$this->module."/Forms.php")){
            ...
            $shortcuts_swap = $this->_getOption('view_print') ? TRUE : $current_user->getPreference('swap_shortcuts');
        ...
        if (isset($_SESSION["authenticated_user_id"]) || $sugar_config['login_nav'] ) {
            ...
            if ( $user_navigation_paradigm == 'gm' && isset($themeObject->group_tabs) && $themeObject->group_tabs) {
                ...
                } else if(isset($moduleExtraMenu['iFrames'])) {
